...
if __name__ == '__main__':
   ...
   # after running this script you will get subfolders named from 0 to 6 in 3 folders named training privatetest and publictest
   # rename training to train publictest to validate and privtetest to test
   # rename subfolders according to the mapping given above